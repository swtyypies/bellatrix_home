...
teks = `*「 ${global.botname} Script 」*\n\nBlogger: ${global.websitex}\nTikTok: ${global.botscript}\n\nJangan Lupa Follow Ya Su`
let buttons = [
...
mediaType:1,
mediaUrl: 'https://www.tiktok.com/@sir.lutz',
sourceUrl: "https://www.tiktok.com/@sir.lutz"
}}
}
...
┏═┅〔 *SUPPORT* 〕┅═
┃⫹⫺ Afrizal (Moderz MLBB)
┃⫹⫺ Sir Lutz (Web Server Management)
┃⫹⫺ Natasya (Owner This Group)
┗═┅〔 *Made By Sir Lutz* 〕┅═`
break
 ...
 break
	...
	const sections = [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "Thanks To Natasya",
										"description": "𝘑𝘢𝘯𝘨𝘢𝘯 𝘓𝘶𝘱𝘢 follow tiktok @sir.lutz",
										"rowId": `${prefix}tqto`
									}
								]
							}
...
const listMessage = {
footer: fot,
text: 'Made By Sir Lutz(TT: @sir.lutz)',
title: con,
